 ...
 * @author chris
 */
public class GuestNameSearchController implements Initializable {

    @FXML
    private ListView<String> listGuests;
    @FXML
    private TextField guestNameText;
    @FXML
    private TextField dateOfArrivalText;
    @FXML
    ...
    @FXML
    private void onClickSearchGuest(ActionEvent event) {
    }
